...
test('no hardcoded credentials exist in source files', function () {
    $filesToCheck = [
        ...
        app_path('Console/Commands/Fetch/FetchAssessments.php'),
        app_path('Console/Commands/Fetch/FetchCircuits.php'),
        app_path('Console/Commands/Fetch/FetchUniqueCycleTypes.php'),
        app_path('Console/Commands/Fetch/FetchUniqueJobTypes.php'),
        app_path('Console/Commands/Fetch/FetchUnitTypes.php'),
        app_path('Console/Commands/Fetch/FetchWsUsers.php'),
